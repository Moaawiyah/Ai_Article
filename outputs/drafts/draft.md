# Scalable Load Balancing Using Programmable Data Planes: The HULA Approach
...
| :--- | :--- | :--- | :--- |
| **HULA** | 0.45 [UNCERTAIN] | < 10 ms | High (Localized updates) |
| **ECMP** | 0.55 [UNCERTAIN] | N/A (Hardware) | Low (Global rehashing) |
| **HyperShift** | 2.40 [UNCERTAIN] | High (Controller bottleneck) | Medium (Stateful updates) |
...
The use of P4 introduces a learning curve for network operators and developers. While P4 is designed to be hardware-agnostic, writing efficient P4 programs requires a deep understanding of packet processing and hardware constraints. Complex algorithms, such as those involving non-linear functions or complex state management, can be difficult to implement efficiently in the P4 pipeline. The complexity of the P4 program can also impact the performance of the switch, as a more complex program may require more resources or result in longer pipeline stages.
...
[1] H. Ballani, P. Francis, T. Zhang, and J. Chandrasekaran, "HULA: Scalable Load Balancing Using Programmable Data Planes," *Proceedings of the 9th ACM Workshop on Research on Networking Systems*, 2016.
